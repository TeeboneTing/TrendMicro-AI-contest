...
if __name__ == '__main__':
    ...
    train_data, val_data = split_train_val(csv_driving_data='data/driving_log-qteam-20180906-cmd_speed.csv')
    ...
    nvidia_net.compile(optimizer='adam', loss=['mse','mse'])
    ...
    nvidia_net.fit_generator(
                         ...
                         steps_per_epoch = 5*(len(train_data)/CONFIG['batchsize']+1),
                         ...
                         validation_steps = 2*(len(val_data)/CONFIG['batchsize']+1),
